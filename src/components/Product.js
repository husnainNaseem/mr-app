      ...
      <div className='container mx-auto flex gap-8'>
        <div className='container w-4/5 my-6 bg-white'>
          <div className='mx-6 py-3'>
            <h1 className='text-2xl text-darkblue font-semibold'>Honda</h1>
            <p className='text-2xl text-darkblue font-semibold pt-1'>Location: Abbottabad</p>
          </div>
        ...
        <div className='2/5 mt-6'>
          <div className='bg-white px-20 py-3 pb-4'>
            <h1 className='text-2xl text-darkblue font-semibold text-center'>Price: PKR 60.5 lacs</h1>
          ...
          <div className='mt-4 text-darkblue font-semibold bg-white'>
            ...
            <div className='flex justify-center pb-2'>
              <img className='border border-darkblue' src='images/th.jpg' alt='profile picture' />
            </div>
            <hr className='w-4/5 mx-auto' />
            <div className='py-2 pl-10'>
              <h1 className='text-lg mt-2'>Owner: Ahmed Affandi</h1>
              <h2 className='text-lg mt-1'>Address: Jhangi syedian, Abbottabad</h2>
            </div>
